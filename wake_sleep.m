...
for iter = 1 : param.epochs
    ...
    for b = 1 : batch_num
		...
		for l = 2 : num_layer
            if l == 2
	            presigmoid = myConvolve(kConv_forward, wake_states{l-1}, model.layers{l}.uw, model.layers{l}.stride, 'forward');
		...
		for l = 1 : num_layer - 2
			if l+1 == 2
				presigmoid = myConvolve(kConv_forward, sleep_states{l}, model.layers{l+1}.uw, model.layers{l+1}.stride, 'forward');
